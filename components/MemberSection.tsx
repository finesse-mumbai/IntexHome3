      ...
      <div className="max-w-[1440px] mx-auto px-12 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
        ...
        <div className="space-y-12">
          <div className="space-y-4">
            <span className="text-[14px] font-black tracking-[0.5em] uppercase text-archive-clay">Membership</span>
          ...
          <ul className="space-y-6">
            {[
              ...
              <li key={i} className="flex items-center gap-6 text-[14px] font-black tracking-[0.2em] uppercase text-archive-bronze">
          ...
          <button className="px-12 py-6 bg-archive-charcoal text-archive-cream font-black text-[14px] tracking-[0.4em] uppercase hover:bg-archive-clay hover:text-archive-cream border border-archive-charcoal hover:border-archive-clay transition-all">
            Become a Member
          </button>
        </div>
      </div>
