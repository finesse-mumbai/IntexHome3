        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-32 gap-12">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[14px] font-black tracking-[0.5em] text-archive-clay uppercase">Technical Demographics</span>
            </div>
            <h2 className="text-[14px] md:text-4xl font-black tracking-tighter text-archive-charcoal leading-[0.8] uppercase">
              BUYER <br /><span className="text-outline">PROFILE.</span>
            </h2>
          </div>
          <div className="max-w-md space-y-6">
            <p className="text-[14px] font-bold tracking-widest text-archive-bronze opacity-60 uppercase">
              A sophisticated matrix of global sourcing entities, from high-street fashion labels to industrial textile exporters.
            </p>
            <div className="flex items-center gap-8 text-[14px] font-black tracking-widest text-archive-charcoal">
          ...
          >
            ...
            <div className="relative z-10 space-y-6 max-w-2xl">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[15px] font-black tracking-[0.5em] text-archive-clay uppercase">Direct Access Portal</span>
              </div>
              ...
              <p className="text-[15px] font-bold tracking-widest text-archive-cream/40 uppercase">
            ...
            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-3 gap-4 w-full lg:w-auto">
              <a
                ...
                className="flex items-center justify-between px-6 py-5 bg-archive-clay text-archive-cream group/btn hover:bg-white hover:text-archive-charcoal transition-all duration-500 min-w-[200px]"
              >
                <span className="text-[15px] font-black tracking-[0.3em] uppercase">Buyer Registration</span>
              ...
              <button className="flex items-center justify-between px-6 py-5 border border-archive-clay/40 bg-white/5 text-archive-clay group/btn hover:bg-archive-clay hover:text-white transition-all duration-500 min-w-[200px]">
                <span className="text-[15px] font-black tracking-[0.3em] uppercase">View All Profile</span>
                <ArrowRight size={16} className="transition-transform group-hover/btn:translate-x-1" />
              </button>
            </div>

            {/* Technical Detail */}
            <div className="absolute top-8 left-8 lg:left-auto lg:right-8 text-[15px] font-black tracking-widest text-white/20">
    ...
    >
      ...
      <div className="flex justify-between items-start relative z-10 shrink-0">
        <div className="space-y-1">
          <span className="text-[14px] font-black text-archive-clay tracking-[0.4em] block uppercase">{serial}</span>
