              ...
              >
                ...
                <div className="h-[320px] relative overflow-hidden bg-archive-cream/30 p-6 group-hover:p-4 transition-all duration-700">
                  ...
                  <div className="absolute top-4 left-4 bg-white/95 px-3 py-1 group-hover:bg-archive-clay transition-colors z-10 shadow-sm">
                    <span className="text-[9px] font-mono font-black text-archive-charcoal group-hover:text-white tracking-tighter">{bulletin.id}</span>
                  </div>
                </div>
                ...
                <div className="flex-1 p-8 flex flex-col justify-between group-hover:text-white transition-colors duration-700">
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <h3 className="text-xl font-black text-archive-charcoal tracking-tighter leading-tight group-hover:text-white transition-colors duration-500 uppercase">
                  ...
                  <div className="relative z-10 pt-10 border-t border-archive-charcoal/5 group-hover:border-white/10 mt-auto flex justify-end items-end">
                    ...
                    >
                      READ <Download size={14} className="uppercase" />
                    </a>
                  </div>
                </div>
              </motion.div>
      ...
      <section className="py-40 px-6 md:px-12 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          <div className="space-y-12">
            <div className="space-y-6">
              <h2 className="text-sm font-black text-archive-clay leading-none uppercase">Journalistic Integrity.</h2>
          ...
          <div className="bg-archive-charcoal p-16 text-white space-y-12 relative overflow-hidden">
            ...
            <div className="space-y-4 relative z-10">
              <span className="text-archive-clay text-[10px] font-black tracking-[0.5em]">Press Registry</span>
              <h3 className="text-xl font-black leading-none uppercase">Access the Full <br /> Editorial Server.</h3>
            </div>
