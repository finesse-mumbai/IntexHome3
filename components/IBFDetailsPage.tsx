    ...
    <div className="bg-archive-cream min-h-screen selection:bg-archive-clay selection:text-white overflow-hidden">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-archive-charcoal">
        ...
        <div className="relative z-10 container mx-auto px-12 text-center space-y-12">
          ...
          >
            <div className="px-6 py-2 bg-archive-clay text-white text-[14px] font-black tracking-[0.6em] uppercase">
              Seminar Series // 2025
            </div>
        ...
        <div className="absolute bottom-12 left-12 flex flex-col items-start gap-4">
          ...
          <span className="text-[14px] font-black tracking-[0.5em] text-white/30 uppercase vertical-text">Explore Archive</span>
        </div>
      </section>
          ...
          <div className="lg:col-span-5 relative">
            <div className="sticky top-32 space-y-12">
              <div className="space-y-6">
                <span className="text-archive-clay text-[14px] font-black tracking-[0.6em] uppercase block">01 // Protocol</span>
              ...
              <p className="text-[14px] font-bold tracking-[0.1em] leading-relaxed text-archive-charcoal/60 max-w-sm uppercase">
              ...
              <div className="relative z-10 space-y-10">
                ...
                <div className="grid grid-cols-2 gap-12 pt-10 border-t border-archive-charcoal/5">
                  <div className="space-y-2">
                    <span className="text-[14px] font-black text-archive-clay tracking-widest uppercase">Focus Vector A</span>
                    <span className="text-[14px] font-black text-archive-charcoal uppercase">AI Implementation</span>
                  </div>
                  <div className="space-y-2">
                    <span className="text-[14px] font-black text-archive-clay tracking-widest uppercase">Focus Vector B</span>
                    <span className="text-[14px] font-black text-archive-charcoal uppercase">Tariff Dynamics</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              {[
                ...
                <div key={i} className="p-10 border border-archive-charcoal/10 hover:border-archive-clay transition-all duration-500 bg-white group">
                  ...
                  <span className="text-[14px] font-black tracking-widest text-archive-charcoal/30 uppercase">{item.label}</span>
      ...
      <section className="bg-white py-48 border-y border-archive-charcoal/10 relative">
        ...
        <div className="absolute top-0 left-0 w-full h-8 bg-archive-charcoal/5 flex items-center overflow-hidden pointer-events-none">
          <div className="flex gap-20 whitespace-nowrap text-[14px] font-black text-archive-charcoal/20 uppercase tracking-[1em] animate-scroll">
        ...
        <div className="max-w-[1440px] mx-auto px-12">
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-32">
            <div className="space-y-4">
              <span className="text-archive-clay text-[14px] font-black tracking-[0.6em] uppercase">02 // Schedule</span>
              <h2 className="text-6xl font-black tracking-tighter text-archive-charcoal uppercase leading-none">The Sessions.</h2>
            </div>
            <p className="text-[14px] font-black text-archive-charcoal/40 uppercase tracking-widest border-l-2 border-archive-clay pl-6 py-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-archive-charcoal/10 border border-archive-charcoal/10 h-max">
            ...
            <div className="bg-white p-12 md:p-20 space-y-16 group hover:translate-y-[-10px] transition-all duration-700">
              <div className="flex justify-between items-start">
                <div className="px-4 py-1 bg-archive-clay text-white text-[14px] font-black tracking-widest uppercase">DHAKA_IBF_25A</div>
                <span className="text-[14px] font-mono text-archive-charcoal/40">TS_001</span>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-wrap gap-10">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[14px] font-black text-archive-charcoal/60 uppercase">26/06/2025</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Clock size={12} className="text-archive-clay" />
                    <span className="text-[14px] font-black text-archive-charcoal/60 uppercase">16:00 - 17:00</span>
                  </div>
                </div>
              </div>

              <div className="space-y-8 pt-12 border-t border-archive-charcoal/5">
                <span className="text-[14px] font-black tracking-[0.4em] text-archive-clay uppercase">Panel Manifest</span>
                <div className="grid gap-6">
                  {[
                    ...
                    <div key={i} className="flex justify-between items-center group/item hover:pl-4 transition-all duration-300">
                      <p className="font-black text-archive-charcoal text-[14px] uppercase tracking-tighter">{s.name}</p>
                      <p className="text-[14px] font-mono text-archive-charcoal/30 uppercase">{s.role}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="bg-archive-charcoal p-12 md:p-20 space-y-16 group text-white hover:translate-y-[-10px] transition-all duration-700">
              <div className="flex justify-between items-start">
                <div className="px-4 py-1 bg-white text-archive-charcoal text-[14px] font-black tracking-widest uppercase">DHAKA_IBF_25B</div>
                <span className="text-[14px] font-mono text-white/40">TS_002</span>
              </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-wrap gap-10">
                  <div className="flex items-center gap-3">
                    <Calendar size={12} className="text-archive-clay" />
                    <span className="text-[14px] font-black text-white/60 uppercase">27/06/2025</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Clock size={12} className="text-archive-clay" />
                    <span className="text-[14px] font-black text-white/60 uppercase">16:00 - 17:00</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8 pt-12 border-t border-white/5">
                ...
                <div className="grid gap-6">
                  {[
                    ...
                    <div key={i} className="flex justify-between items-center group/item hover:pl-4 transition-all duration-300">
                      <p className="font-black text-white text-[14px] uppercase tracking-tighter">{s.name}</p>
                      <p className="text-[14px] font-mono text-white/30 uppercase">{s.role}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="py-48 px-12">
        <div className="max-w-[1440px] mx-auto space-y-32">
          <div className="flex flex-col items-center gap-8 text-center">
            <span className="text-archive-clay text-[14px] font-black tracking-[0.8em] uppercase">03 // Archive</span>
            ...
            {[...Array(12)].map((_, i) => (
              <div key={i} className={`relative group aspect-[3/4] overflow-hidden bg-archive-charcoal/5 border border-archive-charcoal/10 ${i % 3 === 0 ? 'md:col-span-2 md:aspect-video' : ''}`}>
                <div className="absolute inset-0 z-0 bg-archive-charcoal/40 opacity-0 group-hover:opacity-100 transition-opacity duration-700 p-8 flex flex-col justify-end">
                  <span className="text-[14px] font-black text-white tracking-[0.5em] uppercase">Capture // 0{i + 1}</span>
                  <span className="text-[14px] font-black text-white/40 uppercase">IBF Seminar 2025</span>
                </div>
      ...
      <section className="px-12 pb-64">
        <div className="max-w-[1440px] mx-auto bg-archive-charcoal rounded-[48px] p-24 md:p-48 text-center space-y-16 relative overflow-hidden group">
          ...
          <div className="relative z-10 space-y-8">
            <span className="text-archive-clay text-[14px] font-black tracking-[1em] uppercase block">Finalize Protocol</span>
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-center gap-8">
            <button
              ...
              className="px-16 py-8 bg-white text-archive-charcoal font-black text-[14px] tracking-[0.5em] uppercase hover:bg-archive-clay hover:text-white transition-all duration-500 shadow-2xl"
            >
              Return to Dashboard
            </button>
            <button className="px-16 py-8 border border-white/20 text-white font-black text-[14px] tracking-[0.5em] uppercase hover:bg-white hover:text-archive-charcoal transition-all duration-500">
              Partner Protocols
            </button>
          </div>
        </div>
