...
export const BUYER_PROFILES: BuyerImageProfile[] = [
  { title: 'Apparel Brands', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/ApparelBrands.9506fe07.png' },
  { title: 'Fashion Design Studios', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/FashionDesignStudios.dea7074a.png' },
  { title: 'Fashion Designers & Private Labels', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/FashionDesignersPrivateLabels.aec0804f.png' },
  { title: 'Apparel Exporters', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/ApparelExporters.8e55a3ea.png' },
  { title: 'Apparel Manufacturers', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/ApparelManufacturers.1347c5cd.png' },
  { title: 'International Brands & Retailers', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/InternationalBrandsRetailers.e3d93765.png' },
  { title: 'International Sourcing Offices', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/InternationalSourcingOffices.86a983b7.png' },
  { title: 'Buying Agents', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/BuyingAgents.4c437846.png' },
  { title: 'Buying Houses', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/BuyingHouses.adbb6c76.png' },
  { title: 'Merchant Exporters', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/MerchantExporters.1b549663.png' },
  { title: 'Retail Chain Stores', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/RetailChainStores.821ba1bb.png' },
  { title: 'Chambers of Commerce', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/ChambersofCommerce.55a94f95.png' },
  { title: 'Denim Brands', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/DenimBrands.f398081e.png' },
  { title: 'Textile Exporters', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/TextileExporters.8d0cb09c.png' },
  { title: 'Textile Importers', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/TextileImporters.45dabbcc.png' },
  { title: 'Denim Exporters', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/DenimExporters.2ea8a381.png' },
  { title: 'Denim Manufacturers', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/DenimManufacturers.303cc930.png' },
  { title: 'Textile Manufacturers', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/TextileManufacturers.a52c80d3.png' },
  { title: 'Trade Associations', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/TradeAssociations.7443fa9b.png' },
  { title: 'Distributors', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/Distributors.644bd07a.png' },
  { title: 'E-tailers', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/Etailers.c0fe1ec8.png' },
  { title: 'Trading Houses', imageUrl: 'https://sl.intexsouthasia.com/_next/static/media/TradingHouses.5af1b773.png' }
];
